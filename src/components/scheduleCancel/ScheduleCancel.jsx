        ...
        {Array.isArray(appointments.message) && appointments.message.map((appointment) => (
          <li key={appointment.Id} className={styles.appointmentItem}>
            ...
            <div className={styles.buttonGroup}>
              <button className={styles.editButton} onClick={() => handleEdit(appointment.Id, appointment.UserId)}>Edit</button>
              <button className={styles.deleteButton} onClick={() => handleCancel(appointment.Id, appointment.UserId)}>Cancel</button>
            </div>
          </li>
        ))}
      </ul>
